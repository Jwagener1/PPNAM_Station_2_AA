...
## Corpus Check
- 3151 files · ~10,288,262 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2645 nodes · 3860 edges · 254 communities (136 shown, 118 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 369 edges (avg confidence: 0.79)
...
9. `World` - 28 edges
10. `MixingBoardUseCaseTest` - 27 edges
...
Cohesion: 0.05
Nodes (15): IngredientScanResultResponse, ActiveJobCardsInvalidatedResponse, ActiveJobCardsListResponse, ActiveJobCardSummary, BagSizeOptionResponse, BomLineResponse, BomLoadedResponse, CollectionResumePayload (+7 more)
...
Cohesion: 0.12
Nodes (7): Flow, Job, List, StateFlow, Unit, MixingViewModel, MutableSharedFlow
...
Cohesion: 0.16
Nodes (23): DialogFormColumn(), Modifier, BoardSelection, BoardSheet, Collection, CycleSheet, ForceCloseDialog, MachineTab (+15 more)
...
Cohesion: 0.13
Nodes (14): List, MixingBoardUseCase, Accepted, ActiveCycle, ActiveRun, AreaOverview, CollectedMaterial, EquipmentRole (+6 more)
...
Cohesion: 0.16
Nodes (6): computeHighlightedMachines(), Set, Boolean, List, String, ReadyMix
...
Cohesion: 0.15
Nodes (5): IngredientExceptionApproval, Double, Int, String, PendingIngredientScan
...
Cohesion: 0.12
Nodes (7): Job, StateFlow, String, RfidViewModel, Boolean, String, RfidViewModelTest
...
Cohesion: 0.21
Nodes (8): Activity, LoginScreen(), AppNavGraph(), findActivity(), AppScaffold(), checklistTone(), IngredientScanScreen(), RowScope
...
Cohesion: 0.29
Nodes (5): AreaPicker, Board, Error, Loading, MixingBoardUiState
...
Cohesion: 0.47
Nodes (4): StatusCard(), StatusTone, cardTone(), JobLookupScreen()
