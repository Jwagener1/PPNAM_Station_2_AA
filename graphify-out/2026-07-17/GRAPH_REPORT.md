# Graph Report - PPNAM_Station_2_AA  (2026-07-17)

## Corpus Check
- 118 files · ~138,909 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1260 nodes · 1654 edges · 130 communities (59 shown, 71 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 144 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6b4a850`
...
Cohesion: 0.05
Nodes (20): StateFlow, String, OperatorSession, OperatorSessionHolder, HomeViewModel, Flow, StateFlow, Unit (+12 more)
...
Cohesion: 0.09
Nodes (25): ProductionOrder, Cancelling, CancelOutcome, Confirmed, EnteringBagDetails, Error, Failed, Idle (+17 more)
...
Cohesion: 0.13
Nodes (10): BadgeLoginPayload, CredentialsLoginPayload, OperatorContextResponse, AuthUseCase, Badge, Credentials, String, LoginMethod (+2 more)
...
Cohesion: 0.07
Nodes (21): HoldingRecoveryPayload, PalletLookupPayload, PalletInfo, PalletState, Unit, List, String, PalletUseCase (+13 more)
...
Cohesion: 0.09
Nodes (16): Any, Boolean, Class, Long, StateFlow, String, T, MqttConnectionState (+8 more)

### Community 33 - "MixingViewModel.kt"
Cohesion: 0.14
Nodes (7): IngredientScanPayload, ShortBagWaiverPayload, IngredientCollectionCancelPayload, Double, String, Unit, MixingUseCase
...
Cohesion: 0.07
Nodes (10): IngredientScanResultResponse, ActiveJobCardsListResponse, ActiveJobCardSummary, BomLineResponse, BomLoadedResponse, CollectionResumePayload, CollectionSummaryResponse, IngredientCollectionCancelResultResponse (+2 more)
...
## Knowledge Gaps
- **409 isolated node(s):** `FailureKind`, `MqttSchema`, `EmptyPayload`, `ResponseEnvelope`, `Keys` (+404 more)
...
- **Why does `MqttRepositoryImpl` connect `MQTT Message Envelope & Repository Impl` to `MqttRepository`, `Room DAO Tests`, `Operator Session & App Entry`, `Offline Queue Repository & RFID Scan Bus`, `MQTT Client Factory & Reconnection Tests`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `MqttRepository` connect `MqttRepository` to `Room DAO Tests`, `Operator Session & App Entry`, `Pre-Mix Hopper Domain Models`, `MQTT Message Envelope & Repository Impl`, `BOM Line Response & Lookup Tests`, `Typed MQTT Result & Repository Contract`, `Operator Login & Auth Use Case`, `Dashboard & RFID Recovery ViewModels`, `App Settings Defaults & Tests`, `Final MQTT Bugfix Round`, `HomeTile`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `MixingViewModel` connect `Mixing ViewModel State Machine` to `MqttRepository`, `MixingViewModel.kt`, `Operator Session & App Entry`, `Pre-Mix Hopper Domain Models`, `BOM Line Response & Lookup Tests`, `Mixing Screen Flow & Navigation`, `LoginViewModelTest`?**
