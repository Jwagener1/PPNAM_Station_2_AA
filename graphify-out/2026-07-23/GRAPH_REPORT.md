...
## Corpus Check
- 1088 files · ~3,062,979 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1918 nodes · 2834 edges · 174 communities (96 shown, 78 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 308 edges (avg confidence: 0.79)
...
Cohesion: 0.06
Nodes (22): BadgeLoginPayload, CredentialsLoginPayload, OperatorContextResponse, canShow(), Boolean, StateFlow, String, OperatorSession (+14 more)

### Community 2 - "Operator Session & App Entry"
Cohesion: 0.13
Nodes (6): Boolean, Int, String, MqttRequestCorrelationTest, TestBody, Map
...
Cohesion: 0.14
Nodes (10): Double, Flow, Int, Job, List, StateFlow, String, Unit (+2 more)
...
Cohesion: 0.23
Nodes (7): HoldingRecoveryPayload, PalletLookupPayload, PalletInfo, PalletState, String, PalletUseCase, Result
...
Cohesion: 0.12
Nodes (12): ActiveCycleDto, ActiveRunDto, EquipmentDto, LayerInputDto, MachineCycleFinishPayload, MachineCycleForceClosePayload, MachineCycleResultResponse, MixingOverviewPayload (+4 more)
...
Cohesion: 0.08
Nodes (9): IngredientScanPayload, ShortBagWaiverPayload, BomLine, Boolean, ProductionOrder, Double, String, Unit (+1 more)
...
Cohesion: 0.07
Nodes (11): IngredientScanResultResponse, ActiveJobCardsListResponse, ActiveJobCardSummary, BomLineResponse, BomLoadedResponse, CollectionResumePayload, CollectionSummaryResponse, IngredientCollectionCancelPayload (+3 more)
...
Cohesion: 0.31
Nodes (3): AreaOverview, ReadyCollection, MixingBoardUseCase
...
Cohesion: 0.07
Nodes (24): Boolean, Long, StateFlow, MqttConnectionState, MqttRepository, ConnectionStatus, connectionStatusFlow(), Boolean (+16 more)
...
Cohesion: 0.38
Nodes (5): MachineCycleStartPayload, MachineCycleOutcome, Any, List, String
...
Cohesion: 0.12
Nodes (3): List, LoginViewModelTest, Exception

### Community 162 - ".readyMix"
Cohesion: 0.15
Nodes (10): Accepted, ActiveCycle, ActiveRun, CollectedMaterial, Failed, MixingArea, ReadyMix, Rejected (+2 more)
...
## Knowledge Gaps
- **595 isolated node(s):** `FailureKind`, `MqttSchema`, `EmptyPayload`, `ReadyMixDto`, `ActiveCycleDto` (+590 more)
...
- **Why does `MqttRepository` connect `MixingViewModel.kt` to `Room DAO Tests`, `Offline Queue Repository & RFID Scan Bus`, `LoginViewModelTest`, `Pre-Mix Hopper Domain Models`, `MQTT Message Envelope & Repository Impl`, `BOM Line Response & Lookup Tests`, `Typed MQTT Result & Repository Contract`, `LoginViewModel`, `App Settings Defaults & Tests`, `Final MQTT Bugfix Round`, `MqttVocabularyTest`, `SettingsViewModelTest`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `MqttRepositoryImpl` connect `MQTT Message Envelope & Repository Impl` to `Room DAO Tests`, `Offline Queue Repository & RFID Scan Bus`, `Operator Session & App Entry`, `MixingViewModel.kt`, `MQTT Client Factory & Reconnection Tests`, `MqttClockSkewTest`, `MqttRepository`, `LoginViewModel.kt`, `.request`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Rejection` connect `Rejection` to `LoginViewModelTest`, `common.py`, `state.py`, `jobcards.py`, `Dashboard Use Case & Tests`, `HomeTile`, `BomLine`?**
